const artistResult = require('./artists_results/taylorswift.json');
...
Object.keys(categoryInsightsMap).forEach((key) => {
    albumScores = categoryInsightsMap[key].albumScores;
    scores = _.map(albumScores, 'score').slice().sort((a,b) => a - b);  
